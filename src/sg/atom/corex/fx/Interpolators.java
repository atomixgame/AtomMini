...
public class Interpolators {
    ...
    /**
     * Composes a list of interpolators together such that they run in parallel.
     */
    ...
    /**
     * Stretches the interpolation period over an entire list of Interpolator
     * children. For example, a two child list will provide the first child 0-1
     * for an input of 0-0.5 and the second child 0-1 for an input of 0.5 to 1.
     */
    ...
    /**
     * Rescales a delegate interpolator to operate in a different range of of
     * inputs. Input of low to high is scaled into 0 to 1 for the delegate
     * interpolator.
     */
    ...
    /**
     * Converts 0 to 1 input into a 0 to 1 sine wave before passing it onto the
     * delegate.
     */
    ...
    /**
     * Converts 0 to 1 input into a 0 to 1 smooth-stepped Hermite interpolation
     * before passing it onto the delegate. Essentially: t * t * (3.0 - 2.0 * t)
     */
    ...
    /**
     * Calls a delegate method over the range min and max based on input between
     * 0 and 1. For example, if min is 0 and max is ten then calling the
     * interpolator with an input of 0.5 will call the delegate method with the
     * value of 5. The specified method must be a single argument method that
