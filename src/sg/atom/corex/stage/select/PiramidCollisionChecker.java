...
/**
 * Check if a colliable is inside 
 * @author cuong.nguyen
 */
public class PiramidCollisionChecker implements CollisionChecker, Predicate<Spatial>{
    ...
    public PiramidCollisionChecker(Vector3f t, Vector3f b1, Vector3f b2, Vector3f b3, Vector3f b4) {
        this.t = t;
        this.b1 = b1;
        this.b2 = b2;
        this.b3 = b3;
    ...
    public PiramidCollisionChecker(Camera cam, SelectRectUI selectRectUI) {
        float x, y, x1, y1;
    ...
    public boolean apply(Spatial spatial) {
