 ...
 */
package sg.atom.ui.nifty.controls;
...
public class PlayerInfoList implements ListBoxViewConverter<PlayerInfo> {
    ...
    public final void display(final Element listBoxItem, final PlayerInfo item) {
        final Element name = listBoxItem.findElementByName(INFO_LINE_NAME);
        final Element score = listBoxItem.findElementByName(INFO_LINE_SCORE);
        final Element num = listBoxItem.findElementByName(INFO_LINE_NUM);
        final Element icon = listBoxItem.findElementByName(INFO_LINE_ICON);
